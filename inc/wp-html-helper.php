...
// image default alt
if ( ! function_exists( 'eventcon_img_default_alt' ) ) {
	function eventcon_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'eventcon_img_tag' ) ) {
	function eventcon_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = eventcon_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'eventcon_anchor_tag' ) ) {
	function eventcon_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'eventcon_heading_tag' ) ) {
	function eventcon_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'eventcon_paragraph_tag' ) ) {
	function eventcon_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'eventcon_other_tag' ) ) {
	function eventcon_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'eventcon_button_element ' ) ) {
	function eventcon_button_element( array $args ) {
