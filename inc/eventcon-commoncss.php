...
// enqueue css
function eventcon_common_custom_css(){
    
    wp_enqueue_style( 'eventcon-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= eventcon_opt( 'eventcon_theme_color' ) != '#131313' ? eventcon_opt( 'eventcon_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= eventcon_opt( 'eventcon_book_btn_color' ) != '#131313' ? eventcon_opt('eventcon_book_btn_color') : '';
		$bookBtnHoverBgColor     	= eventcon_opt( 'eventcon_book_btn_hvr_bg_color' ) != '#131313' ? eventcon_opt('eventcon_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = eventcon_opt( 'eventcon_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = eventcon_opt( 'eventcon_navbar_bg_color' ) != '#082b49' ? eventcon_opt( 'eventcon_navbar_bg_color') : '';
		$headerTop_col     		  = eventcon_opt( 'eventcon_top_header_color' );

		$headerTopBg      		  = eventcon_opt( 'eventcon_top_header_bg_color');
		$headerBg          		  = eventcon_opt( 'eventcon_header_bg_color') != '#ffffff' ? eventcon_opt( 'eventcon_header_bg_color') : '';
		$menuColor          	  = eventcon_opt( 'eventcon_header_menu_color' ) != '#131313' ? eventcon_opt('eventcon_header_menu_color') : '';
		$menuHoverColor           = eventcon_opt( 'eventcon_header_menu_hover_color' ) != '#808080' ? eventcon_opt('eventcon_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = eventcon_opt( 'eventcon_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = eventcon_opt( 'eventcon_header_drop_menu_bg_color' ) != '#ffffff' ? eventcon_opt('eventcon_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = eventcon_opt( 'eventcon_dropdown_menu_color' ) != '#131313' ? eventcon_opt('eventcon_dropdown_menu_color') : '';
		$dropMenuHovColor         = eventcon_opt( 'eventcon_dropdown_menu_hover_color' ) != '#808080' ? eventcon_opt('eventcon_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = eventcon_opt( 'eventcon_footer_widget_bg_color' );
		$footerwHeadColor   	  = eventcon_opt('eventcon_footer_widget_heading_color');
		$footerwTextColor   	  = eventcon_opt('eventcon_footer_widget_text_color');
		$footerwanchorcolor 	  = eventcon_opt('eventcon_footer_widget_anchor_color') != '#ffffff' ? eventcon_opt('eventcon_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = eventcon_opt('eventcon_footer_widget_anchor_hover_color') != '#ffffff' ? eventcon_opt('eventcon_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = eventcon_opt('eventcon_fof_bg_color');
		$foftonecolor			  = eventcon_opt('eventcon_fof_textone_color');
		$fofttwocolor			  = eventcon_opt('eventcon_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = eventcon_opt('eventcon_footer_widget_anchor_color') != '#9e9e9e' ? eventcon_opt('eventcon_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.eventcon_part .btn_2, .blog_area a h2:hover
			{
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .eventcon_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .eventcon_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'eventcon-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'eventcon_common_custom_css', 50 );